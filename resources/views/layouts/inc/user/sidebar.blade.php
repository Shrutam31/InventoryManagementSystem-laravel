          ...
          <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{url('')}}">Accept Supplies</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('/supplier')}}">Return Supplies</a></li>
                
                <li class="nav-item"> <a class="nav-link" href="{{url('')}}">Accepted Supplies</a></li>
